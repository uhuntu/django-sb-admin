...
urlpatterns = [
    ...
    path('index/', TemplateView.as_view(
        template_name="django_sb_admin/index-new.html"),
        name='sb_admin_index'
    ),
    ...
    url(r'^bootstrap-elements/$', django_sb_admin.views.bootstrap_elements,
        name='sb_admin_bootstrap_elements'),
    url(r'^bootstrap-grid/$', django_sb_admin.views.bootstrap_grid,
        name='sb_admin_bootstrap_grid'),
    url(r'^rtl-dashboard/$', django_sb_admin.views.rtl_dashboard,
